...
- [x] Day 6 deliverables and output paths defined

## Current status
- [x] Day 6 technical plan documented (`DAY6_technical_note.md`)
- [x] Run Day 6 estimation/diagnostic scripts (`scripts/day6_robustness_and_dispersion.py`)
- [x] Export day6 tables/plots to `data/processed/day6/`
- [x] Draft Day 6 interpretation addendum (see notes below)

## Immediate next execution steps
1. Create `scripts/day6_robustness_and_dispersion.py`
2. Execute pipeline on existing day4-ready panels
...
## Day 6 interpretation snapshot
- **Inference robustness:** Pooled near-zero estimate remains directionally stable under city-between proxy uncertainty bands.
- **Continuity checks:** Predetermined covariates around ±7-day cutoff show no detectable discontinuities in this panel setup.
