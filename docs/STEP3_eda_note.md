...
- Across city-step means, average nightly price is 380.48 USD pre-cutoff versus 380.44 USD post-cutoff.
...
- Composite support-ok flag (balanced pre/post observations and step coverage): 24 of 24 cells.
